...
/**
 * Class for mapping Tika metadata names to and from ExifTool metadata names.
 *
 * @author rgauss
 *
 */
public class ExiftoolTikaMapper {

    private static final Map<Object, List<Property>> _tikaToExiftoolMetadataMap = new HashMap<Object, List<Property>>();
    private static final Map<Property, List<Object>> _exiftoolToTikaMetadataMap = new HashMap<Property, List<Object>>();
    ...
    static {
    	...
    	for (Object tikaMetadata : _tikaToExiftoolMetadataMap.keySet()) {
			for (Property exiftoolMetadata : _tikaToExiftoolMetadataMap.get(tikaMetadata)) {
				List<Object> mapping = _exiftoolToTikaMetadataMap.get(exiftoolMetadata);
				if (mapping == null) {
     ...
     */
    public static Map<Object, List<Property>> getTikaToExiftoolMetadataMap() {
	 ...
	 */
	public static Map<Property, List<Object>> getExiftoolToTikaMetadataMap() {
